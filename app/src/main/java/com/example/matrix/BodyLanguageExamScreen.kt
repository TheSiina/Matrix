...
// آزمون جامع تکنیک‌های زبان بدن (استفاده مجدد از ExamScreen و Question)
...
fun loadBodyExamQuestions(context: Context): List<Question> {
    return try {
...
fun BodyExamScreen(
    ...
    val allQuestions = remember { loadBodyExamQuestions(context) }
    ...
    ExamScreen(
        ...
        onScoreSaved = { score ->
            ...
            prefs.edit().putInt("body_score_$keySuffix", score).apply()
        }
    )
}
